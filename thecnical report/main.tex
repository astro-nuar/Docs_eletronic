...
\begin{itemize}
    \item SRAD -- Student Research and Development
...
\begin{itemize}
    \item \textbf{Dimensions:} 200\,mm $\times$ 119\,mm (inner diameter)
    \item \textbf{Possible PCB positioning:} triangular configuration
\end{itemize}
...
\section{Control Logic / Operating System}
\begin{itemize}
    \item The COTS system will always send the recovery deployment signal.
    \item It will overrule any other signal sent by the SRAD computer.
    \item RTOS: FreeRTOS
\end{itemize}

\section{Control System / Dynamics}
\emph{(Section Placeholder)}
