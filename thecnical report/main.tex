...
The complete hardware setup used during development is illustrated in Fig.~\ref{fig:current_setup}. The STM32F411 development board itself is shown in Fig.~\ref{fig:STM32411}.
...
Key design choices and operational rules for the system are summarized below:
